...
DOCTOR_URL="http://localhost:8080/api/doctors"
RDV_URL="http://localhost:8080/api/rendezvous"
FACTURE_URL="http://localhost:8080/api/factures"
...
# 4. CREATE DOCTOR
echo "\n[4] Creating Doctor..."
DOCTOR_RESPONSE=$(curl -v -X POST "$DOCTOR_URL" \
     -H "Content-Type: application/json" \
     -H "Authorization: Bearer $TOKEN" \
     -d '{
           "fullName": "Dr. Strange",
